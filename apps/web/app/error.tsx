...
export default function GlobalRouteError({
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-iron-50/60 px-4 py-16 dark:bg-dlugomat-950">
      <div className="max-w-lg rounded-2xl border border-iron-200 bg-white p-8 shadow-lg dark:border-dlugomat-800 dark:bg-dlugomat-900">
        <div className="flex items-center gap-3">
          ...
          <h1 className="font-serif text-fluid-2xl font-semibold text-iron-900 dark:text-white">
            Coś poszło nie tak
          </h1>
        </div>
        <p className="mt-4 text-fluid-sm text-iron-600 dark:text-iron-300">
