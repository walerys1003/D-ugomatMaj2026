...
const SEVERITY_STYLE: Record<DeadlineEvent["severity"], string> = {
  ...
  normal: "border-l-4 border-iron-300 dark:border-iron-700",
  low: "border-l-4 border-iron-200 dark:border-iron-800",
};
      ...
      <div className="flex flex-wrap items-baseline justify-between gap-2">
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-0.5">
            <span className="text-xs px-2 py-0.5 rounded-full bg-iron-100 dark:bg-iron-800 text-iron-600 dark:text-iron-400">
