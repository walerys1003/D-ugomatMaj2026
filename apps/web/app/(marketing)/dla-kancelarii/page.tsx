    ...
    <main className="bg-ink-50 dark:bg-ink-950 pb-20">
      <section className="bg-white dark:bg-ink-900 border-b border-ink-200 dark:border-ink-800">
        <div className="container mx-auto px-4 py-16 max-w-4xl text-center">
          ...
          <h1 className="font-display text-4xl md:text-6xl font-semibold text-ink-900 dark:text-ink-50 leading-[1.05]">
            Obsłuż 3× więcej spraw
            <br />
            <span className="text-accent-700">bez powiększania zespołu.</span>
          </h1>
          <p className="text-lg md:text-xl text-ink-600 dark:text-ink-300 mt-4 max-w-2xl mx-auto">
      ...
      <section className="container mx-auto px-4 py-16 max-w-5xl">
        <h2 className="font-display text-3xl font-semibold text-ink-900 dark:text-ink-50 text-center mb-10">
          Co rozwiązujemy
        </h2>
      ...
      <section className="container mx-auto px-4 max-w-4xl">
        <Card elevation="pop">
          <CardContent className="pt-8 pb-8 text-center space-y-4">
            ...
            <blockquote className="font-display text-xl md:text-2xl text-ink-900 dark:text-ink-50 max-w-2xl mx-auto leading-relaxed">
