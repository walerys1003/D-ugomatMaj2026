    ...
    <main className="bg-iron-50 dark:bg-iron-950 pb-20">
      <section className="bg-white dark:bg-iron-900 border-b border-iron-200 dark:border-iron-800">
        <div className="container mx-auto px-4 py-12 max-w-4xl">
          <p className="text-xs uppercase tracking-wider text-iron-500 mb-2">Dla firm</p>
      ...
      <section className="container mx-auto px-4 max-w-5xl space-y-4">
        <h2 className="font-display text-2xl font-semibold text-iron-900 dark:text-iron-50 mb-4">
        ...
        <Card elevation="pop" className="mt-6">
          <CardContent className="pt-6 text-center space-y-3">
            <h3 className="font-display text-xl font-semibold text-iron-900 dark:text-iron-50">
              Porozmawiajmy o wycenie dedykowanej
            </h3>
            <p className="text-sm text-iron-600 dark:text-iron-400 max-w-xl mx-auto">
