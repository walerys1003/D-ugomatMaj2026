      ...
      <section className="container mx-auto px-4 py-10 max-w-5xl space-y-6">
        <div className="grid md:grid-cols-3 gap-4">
          <Card elevation="subtle">
            ...
            <CardContent className="text-sm text-iron-600 dark:text-iron-400 space-y-2">
              <p>OAuth 2.0 (auth code + PKCE) lub API key w nagłówku.</p>
              <code className="block font-mono text-xs px-2 py-1.5 rounded bg-iron-100 dark:bg-iron-800">
        ...
        <Card elevation="pop">
          ...
          <CardContent>
            ...
            <p className="text-xs text-iron-500 mt-4">
        ...
        <Card elevation="subtle">
          ...
          <CardContent>
            <pre className="text-xs font-mono p-4 rounded-lg bg-iron-900 dark:bg-iron-950 text-iron-100 overflow-x-auto">
