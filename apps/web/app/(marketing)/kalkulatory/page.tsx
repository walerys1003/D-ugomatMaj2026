  ...
  return (
    <main className="container mx-auto px-4 py-12 lg:py-16">
      ...
      <header className="mx-auto max-w-3xl text-center">
        <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-iron-200 bg-iron-50 px-3 py-1 text-xs font-medium uppercase tracking-wide text-iron-600 dark:border-dlugomat-800 dark:bg-dlugomat-900 dark:text-iron-300">
          <Calculator className="h-3.5 w-3.5" aria-hidden />
          Kalkulatory prawne
        </div>
        <h1 className="text-fluid-3xl font-semibold tracking-tight text-iron-900 dark:text-iron-100">
      ...
      >
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          <div className="rounded-md border border-iron-200 bg-iron-50 p-4 dark:border-dlugomat-800 dark:bg-dlugomat-900">
            ...
            <div className="mt-1 text-lg font-semibold text-iron-900 dark:text-iron-100">
              {formatPLN(minWage.bruttoGrosze)}
            </div>
            <div className="text-xs text-iron-500">brutto, od {minWage.validFrom}</div>
          </div>
          <div className="rounded-md border border-iron-200 bg-iron-50 p-4 dark:border-dlugomat-800 dark:bg-dlugomat-900">
            <div className="flex items-center gap-2 text-xs uppercase tracking-wide text-iron-500">
            ...
            <div className="text-xs text-iron-500">art. 54 ust. 1 PB, miesięcznie</div>
          </div>
          <div className="rounded-md border border-iron-200 bg-iron-50 p-4 dark:border-dlugomat-800 dark:bg-dlugomat-900">
            <div className="flex items-center gap-2 text-xs uppercase tracking-wide text-iron-500">
            ...
            <div className="text-xs text-iron-500">brutto, od {minPension.validFrom}</div>
          </div>
        </div>
      </section>
      ...
      >
        <h2
          id="calc-rachunek"
          className="mb-4 text-2xl font-semibold text-iron-900 dark:text-iron-100"
        >
