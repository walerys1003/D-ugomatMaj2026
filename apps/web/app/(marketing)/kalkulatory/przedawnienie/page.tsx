    ...
    <div className="bg-gradient-to-b from-iron-50 to-white pb-20 dark:from-dlugomat-950 dark:to-dlugomat-900">
      <section className="container py-12 lg:py-16">
        <nav aria-label="Okruszki" className="mb-6 text-fluid-xs text-iron-500">
          ...
          <span className="text-iron-700 dark:text-iron-200">Przedawnienie</span>
        </nav>
        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_1fr] lg:gap-16">
          <div>
            ...
            <div className="mt-8 space-y-4 text-fluid-sm text-iron-600 dark:text-iron-300">
              <div className="flex gap-3">
                <span aria-hidden className="mt-1 inline-block size-1.5 shrink-0 rounded-full bg-accent-500" />
                <p>
                  <strong className="text-iron-800 dark:text-iron-100">3 lata</strong> — roszczenia
              ...
              <div className="flex gap-3">
                <span aria-hidden className="mt-1 inline-block size-1.5 shrink-0 rounded-full bg-accent-500" />
                <p>
                  <strong className="text-iron-800 dark:text-iron-100">6 lat</strong> — ogólne
              ...
              <div className="flex gap-3">
                <span aria-hidden className="mt-1 inline-block size-1.5 shrink-0 rounded-full bg-accent-500" />
                <p>
                  <strong className="text-iron-800 dark:text-iron-100">Koniec roku</strong> — okresy
