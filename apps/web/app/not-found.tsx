...
export default function NotFound() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-iron-50/60 px-4 py-16 dark:bg-dlugomat-950">
      <div className="max-w-lg rounded-2xl border border-iron-200 bg-white p-8 text-center shadow-lg dark:border-dlugomat-800 dark:bg-dlugomat-900">
        ...
        <p className="mt-4 text-fluid-xs font-semibold uppercase tracking-wider text-iron-500">
          Błąd 404
        </p>
        <h1 className="mt-1 font-serif text-fluid-3xl font-semibold text-iron-900 dark:text-white">
          Nie znaleźliśmy tej strony
        </h1>
        <p className="mt-3 text-fluid-sm text-iron-600 dark:text-iron-300">
