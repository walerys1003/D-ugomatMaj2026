        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          ...
          <label className="flex flex-col gap-1 text-sm md:col-span-3">
            ...
            <textarea
              ...
              className="rounded-md border border-ink-300 dark:border-dlugomat-700 px-3 py-2 bg-transparent font-mono text-xs"
            />
          </label>
        </div>
        <div className="mt-3">
      ...
      <section className="rounded-lg border border-ink-200 dark:border-dlugomat-800 overflow-hidden">
        <table className="w-full text-sm">
          ...
          <tbody>
            ...
            {policies.map((p) => (
              <tr key={p.id} className="border-t border-ink-200 dark:border-dlugomat-800">
                ...
                <td className="p-3 text-xs text-ink-600">{(p.roles ?? []).join(",")}</td>
